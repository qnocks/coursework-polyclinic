...
public class MySkipList<K extends Comparable<K>, V> implements Iterable<V> {
    ...
    public MySkipList(double probability) {
    ...
    protected static class SkipListIterator<K extends Comparable<K>, V> implements Iterator<V> {
